 ...
 */
final class Version20241106204732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, eco_score INT DEFAULT NULL, placement INT DEFAULT NULL, newsletter_subscription TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_challenge (id INT AUTO_INCREMENT NOT NULL, challenge_id_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, completed_at DATETIME DEFAULT NULL, INDEX IDX_D7E904B57B961745 (challenge_id_id), INDEX IDX_D7E904B59D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
